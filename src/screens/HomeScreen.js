...
import { Dimensions, FlatList, Image, ScrollView, StyleSheet, Text, TouchableOpacity, TouchableHighlight, View } from 'react-native';
...
export default class HomeScreen extends React.Component {
  ...
  renderDealItem = ({ item }) => (
    <TouchableHighlight onPress={() => this.onPressDealItem(item)}>
